...
public extension HTTPClient {
    ...
    func get(_ pathComponents: String) -> Future<HTTPResponse, HTTPError> {
    ...
    func get(_ url: URL) -> Future<HTTPResponse, HTTPError> {
    ...
    /// - Parameter request: A `URLRequest` to execute
    func get(_ request: URLRequest) -> Future<HTTPResponse, HTTPError> {
        var request = request
...
public extension HTTPClient {
    ...
    /// - Paramenter url: A `String` to be appended to the base URL
    func post(_ pathComponents: String) -> Future<HTTPResponse, HTTPError> {
        let url = baseURL.appendingPathComponent(pathComponents)
        return post(url)
    }
    ...
    /// - Parameter url: A `URL` object to use for the request
    func post(_ url: URL) -> Future<HTTPResponse, HTTPError> {
        let request = newRequest(url)
        return post(request)
    }
    ...
    /// - Parameter request: A `URLRequest` to execute
    func post(_ request: URLRequest) -> Future<HTTPResponse, HTTPError> {
        var request = request
...
public extension HTTPClient {
    ...
    /// - Paramenter url: A `String` to be appended to the base URL
    func put(_ pathComponents: String) -> Future<HTTPResponse, HTTPError> {
        let url = baseURL.appendingPathComponent(pathComponents)
        return put(url)
    }
    ...
    /// - Parameter url: A `URL` object to use for the request
    func put(_ url: URL) -> Future<HTTPResponse, HTTPError> {
        let request = newRequest(url)
        return post(request)
    }
    ...
    /// - Parameter request: A `URLRequest` to execute
    func put(_ request: URLRequest) -> Future<HTTPResponse, HTTPError> {
        var request = request
...
public extension HTTPClient {
    ...
    /// - Paramenter url: A `String` to be appended to the base URL
    func delete(_ pathComponents: String) -> Future<HTTPResponse, HTTPError> {
        let url = baseURL.appendingPathComponent(pathComponents)
        return delete(url)
    }
    ...
    /// - Parameter url: A `URL` object to use for the request
    func delete(_ url: URL) -> Future<HTTPResponse, HTTPError> {
        let request = newRequest(url)
        return post(request)
    }
    ...
    /// - Parameter request: A `URLRequest` to execute
    func delete(_ request: URLRequest) -> Future<HTTPResponse, HTTPError> {
        var request = request
