...
extension HTTPClient {
    ...
    func execute(_ request: URLRequest) -> AnyPublisher<HTTPOutput, HTTPError> {
...
public extension HTTPClient {
    ...
    func get(_ pathComponents: String) -> AnyPublisher<HTTPOutput, HTTPError> {
...
public extension HTTPClient {
    ...
    /// - Paramenter url: A `String` to be appended to the base URL
    func post(_ pathComponents: String) -> AnyPublisher<HTTPOutput, HTTPError> {
        let url = baseURL.appendingPathComponent(pathComponents)
        return post(url)
    }
...
public extension HTTPClient {
    ...
    /// - Paramenter url: A `String` to be appended to the base URL
    func put(_ pathComponents: String) -> AnyPublisher<HTTPOutput, HTTPError> {
        let url = baseURL.appendingPathComponent(pathComponents)
        return put(url)
    }
...
public extension HTTPClient {
    ...
    /// - Paramenter url: A `String` to be appended to the base URL
    func delete(_ pathComponents: String) -> AnyPublisher<HTTPOutput, HTTPError> {
        let url = baseURL.appendingPathComponent(pathComponents)
        return delete(url)
    }
